...
if 'auth' not in globals() or not auth.user:
    redirect(URL(a='mdag', c='default', f='index'))
...
response.menu = [(T('Home'), False, URL(request.application,'default','index'),
                  [
                      (T('Data Format'), False, URL(request.application,'others','help')),
                      (T('Download software'), False, URL(request.application,'others','downloads')),
...
response.menu = [(T('Database'), False, URL(request.application,'appadmin','index')),
		 (T('System'), False, URL('system'))		]
