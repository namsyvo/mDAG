...
auth_table.email.requires = [IS_EMAIL(error_message=auth.messages.invalid_email),\
...
db.datasets.file_name.requires = IS_UPLOAD_FILENAME(extension = 'txt', error_message =\
                                 'Dataset file: please choose a text file (with extension .txt)')
db.datasets.rep_number.requires = IS_NOT_EMPTY(error_message = 'Dataset parameters:\
                                 please enter name and number of replicates')
...
db.results.perm_number.requires = IS_NOT_EMPTY(error_message = 'Number of permutations: please enter a number')
db.results.perm_number.requires = IS_INT_IN_RANGE(50, 10001, error_message =\
                                  'Number of permutations: please choose an interger in range 50 -> 10,000')
